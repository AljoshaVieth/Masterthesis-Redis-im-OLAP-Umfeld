...
\include{content/2_verwandte_arbeit}
\include{content/2_grundlagen}
\include{content/3_ssb_in_postgres}
\include{content/4_olap-in-redis}
...
\begin{appendices}
\include{appendix/Digitaler_Anhang}
    \include{appendix/A_monthly_reports}
    %\include{appendix/B_another_important_appendix}
    \include{appendix/anleitungen/ssb_daten_generieren}
    \include{appendix/anleitungen/ssb_in_postgresql}
    \include{appendix/ssb_queries}
\end{appendices}
