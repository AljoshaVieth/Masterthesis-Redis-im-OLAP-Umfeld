...
Die Felder innerhalb der Tabellen beginnen mit einem Präfix, bestehend aus dem Anfangsbuchstaben der Tabelle und einem Unterstrich, also etwa d_year in der DATE-Tabelle.
...
Die Faktentabelle LINEORDER wird mit der Dimensionstabelle DATE gejoint und die Daten anhand einer Zeitspanne aus der DATE-Tabelle und den Bereichen der Felder "lo_discount"und "lo_quantity" aus der LINEORDER-Tabelle gefiltert.
Anschließend wird der Umsatz als Summe der Produkte der Felder "lo_extendedprice" und "lo_discount" berechnet und als "revenue" zurückgegeben \cite{oneil_star_2009}.
...
Anschließend wird wie in Q1 der Umsatz gebildet, wobei die Ergebnisse hier noch nach d_year und p_brand1 gruppiert und sortiert werden.  
...
Anschließend werden sie nach "c_nation", "s_region" und "d_year" gruppiert und nach "d_year" sortiert.
...
Dieses Mal wird er durch "d_year" und "c_nation" gruppiert und sortiert.
