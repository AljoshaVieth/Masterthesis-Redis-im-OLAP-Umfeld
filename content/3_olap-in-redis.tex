...
Zunächst wird die verwendete Datenstruktur betrachtet. Anschließend wird ausführlich erläutert, wie die Abfragen in Scala strukturiert und umgesetzt wurden. Im dritten Abschnitt werden die Ergebnisse untersucht und im vierten Abschnitt wird ein vorläufiges Fazit gezogen.
...
\begin{lstlisting}[
    ...
    label=code:redis-olap-client-q1-1-query-string,
    language=Java
]
...
Die Funktion \lstinline|queryFilterCriteria| wird verwendet, um einen Index nach bestimmten Kriterien zu durchsuchen und aus den Ergebnissen einen Query-String für numerische Werte zu erzeugen. Die Funktion ist das Äquivalent zu \cref{code:redis-olap-client-q1-1-query-string,} in Scala.
