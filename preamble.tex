...
\newcommand{\docStreetName}{Zollernstr. 87}
\newcommand{\docPostalCode}{75328}
\newcommand{\docCity}{Schömberg}
\newcommand{\docEmail}{mail@aljoshavieth.de}

% Document data
\newcommand{\docTitle}{Redis im OLAP Umfeld}
\newcommand{\docSubTitle}{Ist Redis im OLAP Umfeld nützlich?}     % leave empty to remove
...
% rename cref for "listing" to "Quellcode-Beispiel"
\crefname{listing}{Quellcode-Beispiel}{Quellcode-Beispiele}
\Crefname{listing}{Quellcode-Beispiel}{Quellcode-Beispiele}
