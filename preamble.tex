...
% Document data
\newcommand{\docTitle}{Evaluierung von Redis als eigenständige Lösung im OLAP-Bereich}
\newcommand{\docSubTitle}{Ein Vergleich der Leistungsfähigkeit anhand des SSB Benchmarks zwischen Redis und PostgreSQL}     % leave empty to remove
