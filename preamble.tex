...
% ##################################################
% Personal data
\newcommand{\docAuthor}{Aljosha Justin Vieth}
\newcommand{\docMatriculationNumber}{271401}
\newcommand{\docStudyProgram}{Informatik}
\newcommand{\docStreetName}{Zollernstraße 87}
\newcommand{\docPostalCode}{75328}
\newcommand{\docCity}{Schömberg}
\newcommand{\docEmail}{mail@aljoshavieth.de}

% Document data
\newcommand{\docTitle}{OLAP in Redis}
\newcommand{\docSubTitle}{Evaluierung von Redis als eigenständige Lösung im OLAP-Bereich. Ein Vergleich der Leistungsfähigkeit anhand des Star Schema Benchmarks zwischen Redis und PostgreSQL.}     % leave empty to remove
\newcommand{\docType}{Master Thesis}
\newcommand{\docSupervisor}{Prof. Dr. Piepmeyer}
\newcommand{\docCoSupervisor}{Dr. Weininger}
\newcommand{\docDeadline}{30.11.2023}
...
\renewcommand{\lstlistingname}{Quellcodebeispiel}
...
% rename cref for "listing" to "Quellcodebeispiel"
\crefname{listing}{Quellcodebeispiel}{Quellcodebeispiele}
\Crefname{listing}{Quellcodebeispiel}{Quellcodebeispiele}



% rename cref for "figure" to "Abbildung"
